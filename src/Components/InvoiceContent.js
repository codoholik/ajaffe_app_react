...
export default function InvoiceContent(props) {
    ...
    return (
        <React.Fragment>
            ...
            <div className="ContentInvoiceActive">
                ...
                <table className='portal-table' id="invoiceTable">
                    <thead>
                        <tr className="portal-tr">
                            ...
                            <th className="portal-th" scope="col">Invoice ID</th>
                            <th className="portal-th" scope="col">Invoice Date</th>
                    ...
                    <tbody>
                        {visibleData.map((item, index) => (
                            <tr key={index} className="portal-tr">
                                ...
                                <td className="portal-td">{item["Invoice ID"]}</td>
                                <td className="portal-td">{item["Invoice Date"]}</td>
